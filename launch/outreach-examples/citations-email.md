...
pointer is checkable against the source span, and the quote is free of output tokens. On the brief's demo, 8 of 8
answers resolved to the exact source span.
